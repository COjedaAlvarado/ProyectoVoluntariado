        ...
        @if($batchFinished)
            <div class="w-full my-3">
                <div x-data={show:true} class="rounded-top">
                    <div class="px-4 py-3 rounded-md cursor-pointer bg-pg-primary-100 shadow"
                        ...
                        <div class="flex justify-between">
                            ...
                            <x-livewire-powergrid::icons.chevron-double-down class="w-5 text-pg-primary-400"/>
                        </div>
                    </div>
                    <div x-show="show"
                        ...
                        @foreach($exportedFiles as $file)
                            <div class="flex w-full p-2">
                                ...
                                <a class="cursor-pointer text-pg-primary-600"

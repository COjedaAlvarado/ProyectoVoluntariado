                    ...
                    <tbody>
                        @foreach ($grupos as $grupo)
                            <tr>
                                ...
                                <button wire:click="editar({{$grupo->id}})" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4"><i class="fa-solid fa-pen-to-square mr-2"></i>Editar</button>
                                <button wire:click="borrar({{$grupo->id}})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4"><i class="fa-solid fa-trash-can mr-2"></i>Borrar</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
